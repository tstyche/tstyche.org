...
You now know the core loop: define a type, write an assertion, run TSTyche and iterate. From here, you can explore:

- [Walkthrough](./walkthrough.mdx) — a tour of the most important features of TSTyche.
- [Expect API](../reference/expect-api.mdx) — the full list of available matchers.
- [File Structure](../project/file-structure.mdx) — how TSTyche discovers test files and how to configure it.

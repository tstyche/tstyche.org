...
To be able to test types TSTyche loads the `typescript` package installed in your project. It checks types programmatically and does not require any dependencies to be installed. This is why the install size of TSTyche is just under 250kB.

...
Because `@ts-expect-error` suppresses *any* errors on the following line, type tests using it cast too wide a net. The APIs under test might change, be renamed, or be removed, but the test will keep passing.

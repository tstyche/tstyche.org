...
TSTyche uses TypeScript’s API to infer types of expressions. For a reminder of some nuanced aspects of the inference, see the [Type Inference](../explanations/type-inference.mdx) page.

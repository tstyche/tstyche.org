...
Use the [`.toBeAssignableWith()`](#to-be-assignable-to) matcher to test type assignability from the different target to source perspective.
...
Use the [`.toBeAssignableTo()`](#to-be-assignable-to) matcher to test type assignability from the different source to target perspective.

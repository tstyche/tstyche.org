...
TSTyche uses TypeScript API to infer types of expressions. For a reminder of some nuanced aspects of the inference, see the [Type Inference](../explanations/type-inference.mdx) page.
...
**Signature.** The type arguments must be provided as tuple type.

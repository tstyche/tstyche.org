...
Unlike [run mode flags](./testing-api.mdx#run-mode-flags), `// @tstyche fixme` directives are not inherited from the parent. They only affect the line following the comment.

...
When a TSConfig file does not include the test file in question, [default compiler options](../project/compiler-options.mdx#default-compiler-options) will be set.

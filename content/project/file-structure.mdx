...
TSTyche is built to test projects of any size and complexity. To learn more, see the [Introduction](../explanations/why-tstyche.mdx) page.
...
The above configuration prevents loading global scope typings from `@types/*` packages and includes only the files needed for type testing.

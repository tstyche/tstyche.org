...
By convention, it is recommended to suffix the unit tests with `.test.*` and the type tests with `.tst.*`. To learn more, see the [Project Structure](../project/project-structure.mdx) page.

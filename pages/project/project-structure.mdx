...
It is also possible to keep unit and type tests in a single shared directory:
...
To use type testing assertions in [unit tests](../get-started/features.mdx#integrating-into-unit-tests), configure TSTyche to include the unit test files in the test run:

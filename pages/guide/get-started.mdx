...
The example below shows how type testing can help to debug a utility type.

## Prerequisites

The minimum supported Node.js version is `18.19`. It is recommended to use the latest Long Term Support (LTS) release.

<Note>

TSTyche supports and tests only against the LTS releases of Node.js. Other releases might work too, but keep in mind that only the LTS releases are considered ready for general use.

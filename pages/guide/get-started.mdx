...
This guide recommends using the latest Long Term Support (LTS) release of Node.js (the minimum required version is `18.19`). To learn more, see the [System Requirements](../reference/requirements.mdx) page.
...
```ansi
[34muses[0m TypeScript 5.7.2[90m with ./tsconfig.json[0m

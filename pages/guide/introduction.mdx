...
TSTyche is a type testing tool that was created to handle hundreds of type test in large monorepos. While that was the initial problem, TSTyche is very easy to use with small projects too.

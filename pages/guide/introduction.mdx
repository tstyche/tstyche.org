...
This guide recommends using the latest Long Term Support (LTS) release of Node.js (the minimum required version is `14.17`). Also the internet connection must be available. To learn more, see the [System Requirements](../reference/requirements.mdx) page.

...
Use the [`--tsconfig`](../reference/command-line.mdx#tsconfig) command line option or the [`tsconfig`](../reference/config-file.mdx#tsconfig) configuration option to specify the path to `tsconfig.json` explicitly or to disable the lookup.

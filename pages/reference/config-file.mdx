...
These features simplify implementation of configuration file parser and might be useful in some situations. For maximum portability, the example on this page follow the [JSON specification](https://www.json.org/json-en.html).

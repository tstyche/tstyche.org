...
The configuration file must contain an object. Comments, single quotes and trailing commas are allowed:
...
- or a path relative to the configuration file: `"./custom-plugin.js"`.
...
- or a path relative to the configuration file: `"./custom-reporter.js"`.

...
The compiler configuration is loaded from the nearest `tsconfig.json` file. To learn more, see the [Project Structure](../guide/project-structure.mdx) page.

</Note>

## Schema

Code editors should be able to pick up configuration file schema from the [JSON Schema Store](https://github.com/schemastore/schemastore) catalog. If that does not work, add the schema URI explicitly:
...
Or use the pattern below to specify the version of TSTyche:

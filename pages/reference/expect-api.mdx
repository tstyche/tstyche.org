...
In mutable context a [literal type is inferred](https://www.typescriptlang.org/docs/handbook/2/everyday-types.html#literal-inference) as its base type:
...
To tell to the type checker that a type should not be widened, use [type assertions](https://www.typescriptlang.org/docs/handbook/2/everyday-types.html#type-assertions):
...
If passed as arguments, the object literals undergo the [excess property checks](https://www.typescriptlang.org/docs/handbook/2/objects.html#excess-property-checks):

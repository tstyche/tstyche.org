...
- `current` points the currently installed version of TypeScript (default),
- minor `x.y` releases, resolves to the latest version in the serries, for example, `4.9` resolves to version 4.9.5,
- patch `x.y.z` releases, like `5.3.2` or `4.8.4`,
...
tstyche --target 4.7,5.3.2,current
```

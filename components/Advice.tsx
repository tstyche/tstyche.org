...
export function Note({ children }: ComponentProps<"div">): ReactElement {
  return (
    <div className="mt-6 flex rounded-md border border-gray-400 py-2 pr-4 dark:border-gray-500">
...
export function Tip({ children }: ComponentProps<"div">): ReactElement {
  return (
    <div className="mt-6 flex rounded-md border border-blue-ribbon-700 py-2 pr-4 dark:border-blue-ribbon-500">
...
export function Warning({ children }: ComponentProps<"div">): ReactElement {
  return (
    <div className="mt-6 flex rounded-md border border-blaze-orange-700 py-2 pr-4 dark:border-blaze-orange-500">
